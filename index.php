...
<html lang="es">
  ...
  <body>
    <header>
      <!-- NAV PRINCIPAL -->
      <nav class="menu">
       <a href="#pipina"> <img src="assets/logob.png" alt="pipina" class="logo" /> </a>
        <ul class="menu_items">
          <li><a href="#info">Pipina</a></li>
    ...
    <!-- INICIO HOME -->
    <section id="pipina">
    <!--   <div class="fondo-pipina">
     <img src="assets/logoe.png" alt="pipina">
      </div> -->
    </section>
    ...
    <section class="info" id="info">
      ...
      <div class="info-col">
        <div class="info-row">
          ...
          <div class="info-img">
          <img src="assets/generaciones.jpeg" alt="pipina">
          </div>
        </div>

        <div class="info-row">
          <div class="info-img">
          <img src="assets/principal2.jpg" alt="pipina">
          </div>
          <div class="info-txt">
          ...
          <p>Sirve para cuando hacemos deporte, cuando estamos al aire libre, cuando viajamos en avión, barco, tren, cuando vamos a recitales, bares, discotecas, al club, cuando salimos a realizar trámites, cuando tenemos puestos de trabajo sin acceso fácil a baños.
            ...
            Para evitar contagios o ensuciarte vos o tu ropa interior.
           <span class="blue"> PIPINA </span> al ser <span class="blue"> POCKET </span> La podes llevar en el bolsillo del pantalón, en la cintura, la guantera, en la mochila, bolso, billetera, valijas, bolsillo, donde se te ocurra.            
          </p>
          </div>
        </div>
    ...
    <section class="caracteristicas">
      ...
      <div class="info-col">
        ...
        <ul>
          ...
          <li>Resistente</li>
          <li><span class="blue">POCKET</span> Plegado que lo hace portátil y discreto, te permite llevarlo en el bolsillo, en el corpiño o donde  te resulte más cómodo y estés habituada para trasladarlo. Compacto y plano.</li>
          <li>El tope trasero  evita el retroceso de la orina y posible escape.</li>
          <li>Con papel higiénico en su interior por si faltara en el baño o si lo usarías en baños químicos o al aire libre.</li>
          <li>De no desear orinar al aire libre, la boquilla de salida se adapta para ubicarla en la boca de una botella o contenedor.</li>
          <li>Descartable, Reciclable y Sustentable.</li>
        </ul>
        </div>
      ...
      <div class="info-col-logo">
          ...
          <div class="info-txt-logo">
          <p>Nuestra empresa se dedica a crear <span class="bold"> soluciones </span> a muchas situaciones incómodas e insalubres que atraviesan 
            la gran mayoría de las mujeres en algún momento de su vida y otras en el día a día. 
            Con <span class="blue">PIPINA</span> ir al baño <span class="bold"> nunca más será un problema.</span>
            La <span class="bold">solución</span> al alcance de tu mano. <br/><span class="bold">Donde y cuando la necesites!</span>
          </p>
          </p>
          </div>
    ...
    <!--MODO DE USO -->
    <section id="mododeuso">
      <div class="mododeuso_tit">
        <p class="subtitulo">Modo de uso</p>
        <h2>Pasos a seguir</h2>
      </div>

      <div class="pasosaseguir-col">
        <div class="pasos">
